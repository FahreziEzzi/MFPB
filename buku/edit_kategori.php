...
if (isset($_GET['id'])) {
    ...
    // Jika 'id' tidak di-set, Anda dapat mengambil tindakan sesuai kebutuhan, misalnya kembali ke halaman sebelumnya atau menampilkan pesan error.
    echo "ID kategori tidak tersedia.";
    exit(); // Keluar dari skrip
}


$kategori = "SELECT * FROM kategori_buku WHERE id = $kategori_id";
$query = mysqli_query($koneksi, $kategori);
            ...
            <div id="content">
                ...
                <div class="container-fluid col-lg-6">
                    ...
                    <form class="user" method="POST"
                        action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?id=<?php echo $kategori_id; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control rounded" id="Kategori" name="kategori" placeholder="Kategori"
                                required><?= $resultKategori['nama_kategori']; ?></textarea>
                        </div>
