                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                            <div class="col-lg-4 mb-4 searchable">
                                <div class="card search-result">
                                    <img src="../buku/<?php echo $row['cover']; ?>" style="width: 100%; height: 300px; object-fit: cover;" class="card-img-top img-fluid" alt="Cover Buku">
                                    <div class="card-body">
                                        ...
                                        <a href="bookmark.php?id=<?= $row['id']; ?>&action=delete" class="btn btn-secondary" onclick="return confirmDelete()">
                                            <i class="fas fa-bookmark"></i> Hapus Bookmark</a>
                                    </div>
                                </div>
                            </div>
                        <?php endwhile; ?>
